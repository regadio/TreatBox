...
urlpatterns = [
    ...
    path('juegos/<int:id_solicitado>/favoritos', views.games_insert_view, name='games_insert_view'),
    path('series/<int:id_solicitado>/favoritos', views.series_insert_view, name='series_insert_view'),
    path('peliculas/<int:id_solicitado>/favoritos', views.movie_insert_view, name='movie_insert_view'),
